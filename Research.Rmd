...
### The sources and traits of bacteria and fungi found in the near-surface atmosphere. [(Winfrey, Socualaya-Torres, Resasco, & Fierer, 2026)](https://journals.asm.org/doi/10.1128/aem.02348-25)
<div class="figure-stack-left">
  <figure>
    ...
    <figcaption style="font-weight:600; font-size:1.0rem; line-height:1.25;">
      REU student and co-author Andrea Torres looking up at a bioaerosol sampler!
    (Savannah River Site, South Carolina)
    </figcaption>
  </figure>
  <figure>
...
<p>
  Want a quick overview of the project? Check out my 2025 CIRES Rendezvous poster of this work here (I admit that the figures are prettier in the final paper!):  
...
<h3 style="clear: both; margin-top: 0em;">Assessing the diversity of soil prokaryotes capable of forming spores using a cultivation-independent approach. (in preparation)</h3>
...
Environmental characteristics that shape bacterial and archaeal communities, such as pH, moisture, and the availability of carbon and nutrients, are highly patchy both temporally and spatially in soil. How do soil microbes survive harsh conditions where they live or survive the journey to patches of soil where conditions are better? Ample research has shown that some bacterial taxa armor themselves in tough spore-like structures in response to conditions unfavorable for growth. However, such a strategy should be adaptive for more than just these few phyla that we know independently evolved and form different types of spores. 

In this project, we combined a culture-independent enrichment approach and marker-gene sequencing to classify putative spore-formers and non-spore formers directly in their soil environment. We discovered a diversity of spore-forming taxa not only in the canonical spore-forming bacterial phyla, but also in phyla not previously recognized to have spore-formers, including Verrucomicrobiota, Planctomycetota, and the archaeal phylum Thermoproteota. To showcase the utility of this database of putative spore-formers in future work, we searched for these spore-formers in two publically available soil datasets, testing our prediction that our spore-formers would be more relatively abundant the more arid the environment where the soil was collected. As expected, we found evidence supporting the importance of sporulation in shaping prokaryote communities in arid soils! This work is exciting because it reveals that a greater diversity than expected of soil prokaryotes can likely sporulate, and that this database will be useful in future studies to generate fresh insights into the ecological roles of spore-forming taxa in the soil.
