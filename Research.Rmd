...
## Other Research
<div class="img-row">
  <img src="assets/img/Ecivile.png" alt="Enallagma civile marked in the field">
...
.img-row img {
  flex: 1 1 200px;      /* grow/shrink with min width ~200px */
