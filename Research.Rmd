...
.centered-img {
  ...
  max-width: 1000px;   /* pick a max width you like, or remove */
...
<figure class="centered-figure">
  ...
  <figcaption style="font-weight:600; font-size:1.15rem; line-height:1.25;">
    Most of my dissertation field research took place in the Corridor Project experimental landscapes at the Savannah River Site, SC, and I'm grateful for Team Corridor and the U.S. Forest Service for making it happen! Photo: Andrea Torres
  </figcaption>
</figure>
...
High UV, rapidly fluctuating temperatures, and few nutrients make the atmosphere a harsh place for microorganisms. Yet, diverse microorganisms are found in the near-surface atmosphere. 

### The diversity and distribution of soil bacteria capable of forming spore-like structures. (in preparation)
