...
As academic ecologists we often state that a goal of our research is to 'inform policy'. But this can be easier said than done—our research papers are primarily written for other ecologists, and are often not the most accessible to policymakers and boots-on-the-ground conservationists! For this reason, I've contributed a few articles to [Conservation Corridor](https://conservationcorridor.org), a website that translates the newest research on landscape and connectivity science into accessible research summaries. You can check out my digests [here](https://conservationcorridor.org/author/claire-winfrey/)! I hope to write more pieces for general or non-academic audiences, and I'm always open to new ideas and opportunities!

I've also given public talks about my research and other topics in ecology, in venues ranging from the Great Smoky National Park as a Part of their <em>Science at Sugarlands</em> series, to Knoxville Earth Day Fest, to the University of Tennessee Knoxville Science Forum (see the recording [here](https://www.youtube.com/watch?v=Fd8R6lrBYZE)!)

## Other Outreach
<div class="img-row">
<figure>
    <img src="assets/img/Claire2026SpurVolunteering.jpeg" alt="Showing a child pollen under a microscope at “Girls & Science” at Second Saturday at CSU Spur!">
    <figcaption>Showing a child pollen under a microscope at “Girls & Science” at Second Saturday at CSU Spur</figcaption>
  </figure>
  <figure>
